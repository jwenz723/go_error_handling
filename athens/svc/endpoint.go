...
func MakeNewOrderEndpoint(s OrderService) endpoint.Endpoint {
	const op = errors.Op("endpoint.NewOrder")
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(NewOrderRequest)
		orderID, err := s.NewOrder(ctx, req.CustomerID)
		return NewOrderResponse{OrderID: orderID, Err: errors.E(op, err)}, nil
	}
}
...
func (r NewOrderResponse) AppendKeyvals(keyvals []interface{}) []interface{} {
	...
	return append(keyvals,
		...
		"NewOrderResponse.Err.Kind", errors.KindText(e),
		"NewOrderResponse.Err.CustomerID", errors.CustomerID(e),
		"NewOrderResponse.Err.OrderID", errors.OrderID(e),
		"NewOrderResponse.Err.Ops", errors.OpsText(e))
}
